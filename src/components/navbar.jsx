/*in this file we are making the navbar of our website header contains the  Almabetter logo and dark mode button by toggeling the dark mode button it will change its color between white and black*/
...
const Navbar = (props) => {
  return (
    ...
    <nav className="px-12 py-2 shadow-lg bg-white">
    <div>
     ...
     {/* creating Dark Mode Button */}
      ...
      <input
        ...
        >{props.mode === "white" ? "Light Mode" : "Dark Mode"}</label>
      </div>
        </div>
        </nav>
  );
